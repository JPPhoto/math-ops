...
@invocation("min_max_avg", title="Min/Max/Average", tags=["min_max_avg"], version="1.0.1")
...
@invocation("int_conversion", title="Integer to Float Conversion", version="1.0.1")
...
@invocation("float_conversion", title="Float to Integer Conversion", version="1.0.1")
